...
_openclaw_completion() {
    ...
    case "${prev}" in
      ...
      crestodian)
        ...
        ;;
      setup)
        opts=" --workspace --wizard --non-interactive --mode --import-from --import-source --import-secrets --remote-url --remote-token"
        COMPREPLY=( $(compgen -W "${opts}" -- ${cur}) )
        return 0
        ;;
      onboard)
      ...
      backup)
        ...
        ;;
      migrate)
        opts="list plan apply --from --include-secrets --overwrite --dry-run --yes --skill --plugin --backup-output --no-backup --force --json --verify-plugin-apps"
        COMPREPLY=( $(compgen -W "${opts}" -- ${cur}) )
        return 0
        ;;
      doctor)
      ...
      mcp)
        ...
        ;;
      agent)
        opts=" -m, -t, --session-id --agent --model --thinking --verbose --channel --reply-to --reply-channel --reply-account --local --deliver --json --timeout"
        COMPREPLY=( $(compgen -W "${opts}" -- ${cur}) )
        return 0
        ;;
      agents)
      ...
      health)
        ...
        ;;
      sessions)
        opts="list cleanup export-trajectory --json --verbose --store --agent --all-agents --active --limit"
        COMPREPLY=( $(compgen -W "${opts}" -- ${cur}) )
        return 0
        ;;
      commitments)
      ...
      tui)
        ...
        ;;
      cron)
        opts="status list add rm enable disable get show runs run edit "
        COMPREPLY=( $(compgen -W "${opts}" -- ${cur}) )
        return 0
        ;;
      dns)
      ...
      pairing)
        ...
        ;;
      plugins)
        opts="list search inspect enable disable uninstall install update registry doctor build validate init marketplace "
        COMPREPLY=( $(compgen -W "${opts}" -- ${cur}) )
        return 0
        ;;
      channels)
