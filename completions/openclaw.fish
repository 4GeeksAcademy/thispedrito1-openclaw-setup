...
complete -c openclaw -n "__fish_seen_subcommand_from crestodian" -s m -l message -d 'Run one Crestodian request'
complete -c openclaw -n "__fish_seen_subcommand_from crestodian" -l yes -d 'Approve persistent config writes for this request'
complete -c openclaw -n "__fish_seen_subcommand_from crestodian" -l json -d 'Output startup overview as JSON'
...
complete -c openclaw -n "__fish_seen_subcommand_from setup" -l import-from -d 'Migration provider to run during onboarding'
complete -c openclaw -n "__fish_seen_subcommand_from setup" -l import-source -d 'Source agent home for --import-from'
complete -c openclaw -n "__fish_seen_subcommand_from setup" -l import-secrets -d 'Import supported secrets during onboarding migration'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l modern -d 'Use the conversational setup/repair assistant'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l flow -d 'Onboard flow: quickstart|advanced|manual|import'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l cerebras-api-key -d 'Cerebras API key'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l comfy-api-key -d 'Comfy Cloud API key'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l deepinfra-api-key -d 'DeepInfra API key'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l github-copilot-token -d 'GitHub Copilot OAuth token'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l nvidia-api-key -d 'NVIDIA API key'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l openai-api-key -d 'OpenAI API Key Backup'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l tokenhub-api-key -d 'Tencent TokenHub API key'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l custom-image-input -d 'Mark the custom provider model as image-capable'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l custom-text-input -d 'Mark the custom provider model as text-only'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l skip-bootstrap -d 'Skip creating default agent workspace files'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l skip-hooks -d 'Skip hook setup'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l node-manager -d 'Node manager for skills: npm|pnpm|bun'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l import-from -d 'Migration provider to run during onboarding'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l import-source -d 'Source agent home for --import-from'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l import-secrets -d 'Import supported secrets during onboarding migration'
...
complete -c openclaw -n "__fish_seen_subcommand_from config" -a "patch" -d 'Patch config from a JSON5 object in one validated write.
...
complete -c openclaw -n "__fish_seen_subcommand_from set" -l merge -d 'Merge object/map values instead of replacing the target path'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l replace -d 'Allow full replacement of protected map/list paths such as agents.defaults.models'
...
complete -c openclaw -n "__fish_seen_subcommand_from patch" -l file -d 'Read a JSON5 config patch object from file'
complete -c openclaw -n "__fish_seen_subcommand_from patch" -l stdin -d 'Read a JSON5 config patch object from stdin'
complete -c openclaw -n "__fish_seen_subcommand_from patch" -l dry-run -d 'Validate changes without writing openclaw.json (checks schema and SecretRef resolvability; exec SecretRefs are skipped unless --allow-exec is set)'
complete -c openclaw -n "__fish_seen_subcommand_from patch" -l allow-exec -d 'Dry-run only: allow exec SecretRef resolvability checks (may execute provider commands)'
complete -c openclaw -n "__fish_seen_subcommand_from patch" -l json -d 'Output dry-run result as JSON'
complete -c openclaw -n "__fish_seen_subcommand_from patch" -l replace-path -d 'Replace the object or array at this dot/bracket path instead of recursively applying it (repeatable)'
complete -c openclaw -n "__fish_seen_subcommand_from unset" -l dry-run -d 'validate the removal without writing the config file'
complete -c openclaw -n "__fish_seen_subcommand_from unset" -l allow-exec -d 'allow exec SecretRef providers during --dry-run'
complete -c openclaw -n "__fish_seen_subcommand_from unset" -l json -d 'print dry-run result as JSON'
...
complete -c openclaw -n "__fish_seen_subcommand_from migrate" -a "list" -d 'List migration providers'
complete -c openclaw -n "__fish_seen_subcommand_from migrate" -a "plan" -d 'Preview a migration without changing OpenClaw state'
complete -c openclaw -n "__fish_seen_subcommand_from migrate" -a "apply" -d 'Apply a migration after a verified backup'
complete -c openclaw -n "__fish_seen_subcommand_from migrate" -l from -d 'Source directory to migrate from'
complete -c openclaw -n "__fish_seen_subcommand_from migrate" -l include-secrets -d 'Import supported credentials and secrets'
complete -c openclaw -n "__fish_seen_subcommand_from migrate" -l overwrite -d 'Overwrite conflicting target files after item-level backups'
complete -c openclaw -n "__fish_seen_subcommand_from migrate" -l dry-run -d 'Preview only; do not apply changes'
complete -c openclaw -n "__fish_seen_subcommand_from migrate" -l yes -d 'Apply without prompting after preview'
complete -c openclaw -n "__fish_seen_subcommand_from migrate" -l skill -d 'Select one skill to migrate by name or item id; repeat for multiple skills'
complete -c openclaw -n "__fish_seen_subcommand_from migrate" -l plugin -d 'Select one Codex plugin to migrate by name or item id; repeat for multiple plugins'
complete -c openclaw -n "__fish_seen_subcommand_from migrate" -l backup-output -d 'Pre-migration backup archive path or directory'
complete -c openclaw -n "__fish_seen_subcommand_from migrate" -l no-backup -d 'Skip the pre-migration OpenClaw backup'
complete -c openclaw -n "__fish_seen_subcommand_from migrate" -l force -d 'Allow dangerous options such as --no-backup'
complete -c openclaw -n "__fish_seen_subcommand_from migrate" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from migrate" -l verify-plugin-apps -d 'Codex only: verify source plugin app accessibility with app/list before planning native plugin activation'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from plan" -l from -d 'Source directory to migrate from'
complete -c openclaw -n "__fish_seen_subcommand_from plan" -l include-secrets -d 'Import supported credentials and secrets'
complete -c openclaw -n "__fish_seen_subcommand_from plan" -l overwrite -d 'Overwrite conflicting target files after item-level backups'
complete -c openclaw -n "__fish_seen_subcommand_from plan" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from plan" -l skill -d 'Select one skill to migrate by name or item id; repeat for multiple skills'
complete -c openclaw -n "__fish_seen_subcommand_from plan" -l plugin -d 'Select one Codex plugin to migrate by name or item id; repeat for multiple plugins'
complete -c openclaw -n "__fish_seen_subcommand_from plan" -l verify-plugin-apps -d 'Codex only: verify source plugin app accessibility with app/list before planning native plugin activation'
complete -c openclaw -n "__fish_seen_subcommand_from apply" -l from -d 'Source directory to migrate from'
complete -c openclaw -n "__fish_seen_subcommand_from apply" -l include-secrets -d 'Import supported credentials and secrets'
complete -c openclaw -n "__fish_seen_subcommand_from apply" -l overwrite -d 'Overwrite conflicting target files after item-level backups'
complete -c openclaw -n "__fish_seen_subcommand_from apply" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from apply" -l skill -d 'Select one skill to migrate by name or item id; repeat for multiple skills'
complete -c openclaw -n "__fish_seen_subcommand_from apply" -l plugin -d 'Select one Codex plugin to migrate by name or item id; repeat for multiple plugins'
complete -c openclaw -n "__fish_seen_subcommand_from apply" -l verify-plugin-apps -d 'Codex only: verify source plugin app accessibility with app/list before planning native plugin activation'
complete -c openclaw -n "__fish_seen_subcommand_from apply" -l yes -d 'Apply without prompting'
complete -c openclaw -n "__fish_seen_subcommand_from apply" -l backup-output -d 'Pre-migration backup archive path or directory'
complete -c openclaw -n "__fish_seen_subcommand_from apply" -l no-backup -d 'Skip the pre-migration OpenClaw backup'
complete -c openclaw -n "__fish_seen_subcommand_from apply" -l force -d 'Allow dangerous options such as --no-backup'
...
complete -c openclaw -n "__fish_seen_subcommand_from doctor" -l lint -d 'Run read-only health checks and report findings'
complete -c openclaw -n "__fish_seen_subcommand_from doctor" -l json -d 'With --lint: emit JSON findings instead of human output'
complete -c openclaw -n "__fish_seen_subcommand_from doctor" -l severity-min -d 'With --lint: drop findings below this severity (info|warning|error)'
complete -c openclaw -n "__fish_seen_subcommand_from doctor" -l skip -d 'With --lint: skip a specific check id (repeatable)'
complete -c openclaw -n "__fish_seen_subcommand_from doctor" -l only -d 'With --lint: run only the specified check id (repeatable)'
complete -c openclaw -n "__fish_seen_subcommand_from dashboard" -l no-open -d 'Print URL but do not launch a browser'
complete -c openclaw -n "__fish_seen_subcommand_from dashboard" -l yes -d 'Start/install the gateway without prompting when needed'
...
complete -c openclaw -n "__fish_seen_subcommand_from send" -s t -l target -d 'Recipient/channel: E.164 for WhatsApp/Signal, Telegram chat id/@username, Discord/Slack/Mattermost <channelId|user:ID|channel:ID>, or iMessage handle/chat_id'
...
complete -c openclaw -n "__fish_seen_subcommand_from send" -l presentation -d 'Shared presentation payload as JSON (text, context, dividers, buttons, selects)'
complete -c openclaw -n "__fish_seen_subcommand_from send" -l delivery -d 'Shared delivery preferences as JSON'
complete -c openclaw -n "__fish_seen_subcommand_from send" -l pin -d 'Request that the delivered message be pinned when supported'
...
complete -c openclaw -n "__fish_seen_subcommand_from send" -l force-document -d 'Send media as document to avoid channel compression (Telegram, WhatsApp). Applies to images, GIFs, and videos.'
...
complete -c openclaw -n "__fish_seen_subcommand_from send" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from broadcast" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from poll" -s t -l target -d 'Recipient/channel: E.164 for WhatsApp/Signal, Telegram chat id/@username, Discord/Slack/Mattermost <channelId|user:ID|channel:ID>, or iMessage handle/chat_id'
complete -c openclaw -n "__fish_seen_subcommand_from poll" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from react" -s t -l target -d 'Recipient/channel: E.164 for WhatsApp/Signal, Telegram chat id/@username, Discord/Slack/Mattermost <channelId|user:ID|channel:ID>, or iMessage handle/chat_id'
complete -c openclaw -n "__fish_seen_subcommand_from react" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from reactions" -s t -l target -d 'Recipient/channel: E.164 for WhatsApp/Signal, Telegram chat id/@username, Discord/Slack/Mattermost <channelId|user:ID|channel:ID>, or iMessage handle/chat_id'
complete -c openclaw -n "__fish_seen_subcommand_from reactions" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from read" -s t -l target -d 'Recipient/channel: E.164 for WhatsApp/Signal, Telegram chat id/@username, Discord/Slack/Mattermost <channelId|user:ID|channel:ID>, or iMessage handle/chat_id'
complete -c openclaw -n "__fish_seen_subcommand_from read" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from read" -l message-id -d 'Read a specific message id'
...
complete -c openclaw -n "__fish_seen_subcommand_from read" -l thread-id -d 'Thread id (Slack thread timestamp)'
...
complete -c openclaw -n "__fish_seen_subcommand_from edit" -s t -l target -d 'Recipient/channel: E.164 for WhatsApp/Signal, Telegram chat id/@username, Discord/Slack/Mattermost <channelId|user:ID|channel:ID>, or iMessage handle/chat_id'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from delete" -s t -l target -d 'Recipient/channel: E.164 for WhatsApp/Signal, Telegram chat id/@username, Discord/Slack/Mattermost <channelId|user:ID|channel:ID>, or iMessage handle/chat_id'
complete -c openclaw -n "__fish_seen_subcommand_from delete" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from pin" -s t -l target -d 'Recipient/channel: E.164 for WhatsApp/Signal, Telegram chat id/@username, Discord/Slack/Mattermost <channelId|user:ID|channel:ID>, or iMessage handle/chat_id'
complete -c openclaw -n "__fish_seen_subcommand_from pin" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from unpin" -s t -l target -d 'Recipient/channel: E.164 for WhatsApp/Signal, Telegram chat id/@username, Discord/Slack/Mattermost <channelId|user:ID|channel:ID>, or iMessage handle/chat_id'
complete -c openclaw -n "__fish_seen_subcommand_from unpin" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from pins" -s t -l target -d 'Recipient/channel: E.164 for WhatsApp/Signal, Telegram chat id/@username, Discord/Slack/Mattermost <channelId|user:ID|channel:ID>, or iMessage handle/chat_id'
complete -c openclaw -n "__fish_seen_subcommand_from pins" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from permissions" -s t -l target -d 'Recipient/channel: E.164 for WhatsApp/Signal, Telegram chat id/@username, Discord/Slack/Mattermost <channelId|user:ID|channel:ID>, or iMessage handle/chat_id'
complete -c openclaw -n "__fish_seen_subcommand_from permissions" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from search" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from create" -s t -l target -d 'Recipient/channel: E.164 for WhatsApp/Signal, Telegram chat id/@username, Discord/Slack/Mattermost <channelId|user:ID|channel:ID>, or iMessage handle/chat_id'
complete -c openclaw -n "__fish_seen_subcommand_from create" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from list" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from reply" -s t -l target -d 'Recipient/channel: E.164 for WhatsApp/Signal, Telegram chat id/@username, Discord/Slack/Mattermost <channelId|user:ID|channel:ID>, or iMessage handle/chat_id'
complete -c openclaw -n "__fish_seen_subcommand_from reply" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from upload" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from info" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from add" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from remove" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from info" -s t -l target -d 'Recipient/channel: E.164 for WhatsApp/Signal, Telegram chat id/@username, Discord/Slack/Mattermost <channelId|user:ID|channel:ID>, or iMessage handle/chat_id'
complete -c openclaw -n "__fish_seen_subcommand_from info" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
complete -c openclaw -n "__fish_seen_subcommand_from info" -l account -d 'Channel account id (accountId)'
complete -c openclaw -n "__fish_seen_subcommand_from info" -l json -d 'Output result as JSON'
complete -c openclaw -n "__fish_seen_subcommand_from info" -l dry-run -d 'Print payload and skip sending'
...
complete -c openclaw -n "__fish_seen_subcommand_from status" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from timeout" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from kick" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from ban" -l channel -d 'Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch'
...
complete -c openclaw -n "__fish_seen_subcommand_from agent" -l model -d 'Model override for this run (provider/model or model id)'
complete -c openclaw -n "__fish_seen_subcommand_from agent" -l thinking -d 'Thinking level: off | minimal | low | medium | high | xhigh | adaptive | max where supported'
complete -c openclaw -n "__fish_seen_subcommand_from agent" -l verbose -d 'Persist agent verbose level for the session'
complete -c openclaw -n "__fish_seen_subcommand_from agent" -l channel -d 'Delivery channel: last|telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch (omit to use the main session channel)'
...
complete -c openclaw -n "__fish_seen_subcommand_from sessions" -a "list" -d 'List stored conversation sessions'
complete -c openclaw -n "__fish_seen_subcommand_from sessions" -a "cleanup" -d 'Run session-store maintenance now'
complete -c openclaw -n "__fish_seen_subcommand_from sessions" -a "export-trajectory" -d 'Export a redacted trajectory bundle for a stored session'
...
complete -c openclaw -n "__fish_seen_subcommand_from sessions" -l limit -d 'Max sessions to show (default: 100; use "all" for full output)'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Output as JSON'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l verbose -d 'Verbose logging'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l store -d 'Path to session store (default: resolved from config)'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l agent -d 'Agent id to inspect (default: configured default agent)'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l all-agents -d 'Aggregate sessions across all configured agents'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l active -d 'Only show sessions updated within the past N minutes'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l limit -d 'Max sessions to show (default: 100; use "all" for full output)'
...
complete -c openclaw -n "__fish_seen_subcommand_from cleanup" -l fix-dm-scope -d 'Retire stale direct-DM session rows that no longer match session.dmScope=main'
...
complete -c openclaw -n "__fish_seen_subcommand_from export-trajectory" -l session-key -d 'Session key to export'
complete -c openclaw -n "__fish_seen_subcommand_from export-trajectory" -l output -d 'Output directory name inside .openclaw/trajectory-exports'
complete -c openclaw -n "__fish_seen_subcommand_from export-trajectory" -l workspace -d 'Workspace root for the export (default: current directory)'
complete -c openclaw -n "__fish_seen_subcommand_from export-trajectory" -l store -d 'Path to session store (default: resolved from session key)'
complete -c openclaw -n "__fish_seen_subcommand_from export-trajectory" -l agent -d 'Agent id for resolving the default session store'
complete -c openclaw -n "__fish_seen_subcommand_from export-trajectory" -l request-json-base64 -d 'Base64url-encoded export request'
complete -c openclaw -n "__fish_seen_subcommand_from export-trajectory" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from commitments" -a "list" -d 'List inferred follow-up commitments'
complete -c openclaw -n "__fish_seen_subcommand_from commitments" -a "dismiss" -d 'Dismiss inferred follow-up commitments'
complete -c openclaw -n "__fish_seen_subcommand_from commitments" -l json -d 'Output JSON instead of text'
complete -c openclaw -n "__fish_seen_subcommand_from commitments" -l agent -d 'Agent id to inspect'
complete -c openclaw -n "__fish_seen_subcommand_from commitments" -l status -d 'Filter by status (pending, sent, dismissed, snoozed, expired)'
complete -c openclaw -n "__fish_seen_subcommand_from commitments" -l all -d 'Show all statuses'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Output JSON instead of text'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l agent -d 'Agent id to inspect'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l status -d 'Filter by status (pending, sent, dismissed, snoozed, expired)'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l all -d 'Show all statuses'
complete -c openclaw -n "__fish_seen_subcommand_from dismiss" -l json -d 'Output JSON instead of text'
...
complete -c openclaw -n "__fish_seen_subcommand_from gateway" -a "stability" -d 'Fetch payload-free Gateway stability diagnostics'
complete -c openclaw -n "__fish_seen_subcommand_from gateway" -a "diagnostics" -d 'Export local support diagnostics'
...
complete -c openclaw -n "__fish_seen_subcommand_from install" -l wrapper -d 'Executable wrapper for generated service ProgramArguments'
...
complete -c openclaw -n "__fish_seen_subcommand_from stop" -l disable -d 'Persistently suppress KeepAlive/RunAtLoad so the gateway does not respawn until next start (launchd only)'
complete -c openclaw -n "__fish_seen_subcommand_from restart" -l force -d 'Restart immediately without waiting for active gateway work'
complete -c openclaw -n "__fish_seen_subcommand_from restart" -l safe -d 'Request an OpenClaw-aware restart after active work drains'
complete -c openclaw -n "__fish_seen_subcommand_from restart" -l skip-deferral -d 'Bypass the safe-restart deferral gate; requires --safe'
complete -c openclaw -n "__fish_seen_subcommand_from restart" -l wait -d 'Wait duration before forcing restart (ms, 10s, 5m; 0 waits indefinitely)'
...
complete -c openclaw -n "__fish_seen_subcommand_from stability" -l limit -d 'Maximum number of recent events'
complete -c openclaw -n "__fish_seen_subcommand_from stability" -l type -d 'Filter by diagnostic event type'
complete -c openclaw -n "__fish_seen_subcommand_from stability" -l since-seq -d 'Only include events after this sequence'
complete -c openclaw -n "__fish_seen_subcommand_from stability" -l bundle -d 'Read a persisted stability bundle instead of calling Gateway; pass "latest" for newest'
complete -c openclaw -n "__fish_seen_subcommand_from stability" -l export -d 'Write a shareable support diagnostics export'
complete -c openclaw -n "__fish_seen_subcommand_from stability" -l output -d 'Diagnostics export output .zip path'
complete -c openclaw -n "__fish_seen_subcommand_from stability" -l url -d 'Gateway WebSocket URL (defaults to gateway.remote.url when configured)'
complete -c openclaw -n "__fish_seen_subcommand_from stability" -l token -d 'Gateway token (if required)'
complete -c openclaw -n "__fish_seen_subcommand_from stability" -l password -d 'Gateway password (password auth)'
complete -c openclaw -n "__fish_seen_subcommand_from stability" -l timeout -d 'Timeout in ms'
complete -c openclaw -n "__fish_seen_subcommand_from stability" -l expect-final -d 'Wait for final response (agent)'
complete -c openclaw -n "__fish_seen_subcommand_from stability" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from diagnostics" -a "export" -d 'Write a shareable, payload-free diagnostics .zip'
complete -c openclaw -n "__fish_seen_subcommand_from export" -l output -d 'Output .zip path'
complete -c openclaw -n "__fish_seen_subcommand_from export" -l log-lines -d 'Maximum sanitized log lines to include'
complete -c openclaw -n "__fish_seen_subcommand_from export" -l log-bytes -d 'Maximum log bytes to inspect'
complete -c openclaw -n "__fish_seen_subcommand_from export" -l url -d 'Gateway WebSocket URL for health snapshot'
complete -c openclaw -n "__fish_seen_subcommand_from export" -l token -d 'Gateway token for health snapshot'
complete -c openclaw -n "__fish_seen_subcommand_from export" -l password -d 'Gateway password for health snapshot'
complete -c openclaw -n "__fish_seen_subcommand_from export" -l timeout -d 'Status/health snapshot timeout in ms'
complete -c openclaw -n "__fish_seen_subcommand_from export" -l no-stability-bundle -d 'Skip persisted stability bundle lookup'
complete -c openclaw -n "__fish_seen_subcommand_from export" -l json -d 'Output JSON'
...
complete -c openclaw -n "__fish_seen_subcommand_from event" -l session-key -d 'Target a specific session for the event (defaults to the agent'\''s main session)'
...
complete -c openclaw -n "__fish_seen_subcommand_from list" -l provider -d 'Filter by provider id'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Output JSON'
...
complete -c openclaw -n "__fish_seen_subcommand_from auth" -a "list" -d 'List saved auth profiles'
...
complete -c openclaw -n "__fish_seen_subcommand_from auth" -l agent -d 'Agent id for auth commands'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l provider -d 'Filter by provider id'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l agent -d 'Agent id (default: configured default agent)'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Output JSON'
...
complete -c openclaw -n "__fish_seen_subcommand_from login" -l device-code -d 'Use the provider device-code auth method'
...
complete -c openclaw -n "__fish_seen_subcommand_from run" -l file -d 'Image file'
complete -c openclaw -n "__fish_seen_subcommand_from run" -l model -d 'Model override'
complete -c openclaw -n "__fish_seen_subcommand_from run" -l thinking -d 'Thinking level override'
...
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l output-format -d 'Output format hint: png, jpeg, or webp'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l background -d 'Background hint: transparent, opaque, or auto'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l openai-background -d 'OpenAI background hint: transparent, opaque, or auto'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l timeout-ms -d 'Provider request timeout in milliseconds'
...
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l size -d 'Size hint like 1024x1024'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l aspect-ratio -d 'Aspect ratio hint like 16:9'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l resolution -d 'Resolution hint: 1K, 2K, or 4K'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l output-format -d 'Output format hint: png, jpeg, or webp'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l background -d 'Background hint: transparent, opaque, or auto'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l openai-background -d 'OpenAI background hint: transparent, opaque, or auto'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l timeout-ms -d 'Provider request timeout in milliseconds'
...
complete -c openclaw -n "__fish_seen_subcommand_from describe" -l prompt -d 'Prompt hint'
complete -c openclaw -n "__fish_seen_subcommand_from describe" -l model -d 'Model override'
complete -c openclaw -n "__fish_seen_subcommand_from describe" -l timeout-ms -d 'Provider request timeout in milliseconds'
...
complete -c openclaw -n "__fish_seen_subcommand_from describe-many" -l prompt -d 'Prompt hint'
complete -c openclaw -n "__fish_seen_subcommand_from describe-many" -l model -d 'Model override'
complete -c openclaw -n "__fish_seen_subcommand_from describe-many" -l timeout-ms -d 'Provider request timeout in milliseconds'
...
complete -c openclaw -n "__fish_seen_subcommand_from tts" -a "personas" -d 'List TTS personas'
...
complete -c openclaw -n "__fish_seen_subcommand_from tts" -a "set-persona" -d 'Set the active TTS persona'
...
complete -c openclaw -n "__fish_seen_subcommand_from providers" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from personas" -l local -d 'Force local execution'
complete -c openclaw -n "__fish_seen_subcommand_from personas" -l gateway -d 'Force gateway execution'
complete -c openclaw -n "__fish_seen_subcommand_from personas" -l json -d 'Output JSON'
...
complete -c openclaw -n "__fish_seen_subcommand_from set-persona" -l persona -d 'TTS persona id'
complete -c openclaw -n "__fish_seen_subcommand_from set-persona" -l off -d 'Disable the active TTS persona'
complete -c openclaw -n "__fish_seen_subcommand_from set-persona" -l local -d 'Force local execution'
complete -c openclaw -n "__fish_seen_subcommand_from set-persona" -l gateway -d 'Force gateway execution'
complete -c openclaw -n "__fish_seen_subcommand_from set-persona" -l json -d 'Output JSON'
...
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l prompt -d 'Prompt text'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l model -d 'Model override'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l size -d 'Size hint like 1280x720'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l aspect-ratio -d 'Aspect ratio hint like 16:9'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l resolution -d 'Resolution hint: 480P, 720P, 768P, or 1080P'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l duration -d 'Target duration in seconds'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l audio -d 'Enable generated audio when supported'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l watermark -d 'Request provider watermark when supported'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l timeout-ms -d 'Provider request timeout in milliseconds'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l output -d 'Output path'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l json -d 'Output JSON'
...
complete -c openclaw -n "__fish_seen_subcommand_from nodes" -a "remove" -d 'Remove a paired node entry'
...
complete -c openclaw -n "__fish_seen_subcommand_from remove" -l node -d 'Node id, name, or IP'
complete -c openclaw -n "__fish_seen_subcommand_from remove" -l url -d 'Gateway WebSocket URL (defaults to gateway.remote.url when configured)'
complete -c openclaw -n "__fish_seen_subcommand_from remove" -l token -d 'Gateway token (if required)'
complete -c openclaw -n "__fish_seen_subcommand_from remove" -l timeout -d 'Timeout in ms'
complete -c openclaw -n "__fish_seen_subcommand_from remove" -l json -d 'Output JSON'
...
complete -c openclaw -n "__fish_seen_subcommand_from node" -a "start" -d 'Start the node host service (launchd/systemd/schtasks)'
...
complete -c openclaw -n "__fish_seen_subcommand_from tui" -l local -d 'Run against the local embedded agent runtime'
...
complete -c openclaw -n "__fish_seen_subcommand_from cron" -a "get" -d 'Get a cron job as JSON'
...
complete -c openclaw -n "__fish_seen_subcommand_from list" -l agent -d 'Filter by agent id'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l url -d 'Gateway WebSocket URL (defaults to gateway.remote.url when configured)'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l token -d 'Gateway token (if required)'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l timeout -d 'Timeout in ms'
...
complete -c openclaw -n "__fish_seen_subcommand_from add" -l tz -d 'Timezone for cron expressions (IANA; cron default: Gateway host local timezone)'
...
complete -c openclaw -n "__fish_seen_subcommand_from add" -l thread-id -d 'Telegram forum topic thread id'
...
complete -c openclaw -n "__fish_seen_subcommand_from get" -l token -d 'Gateway token (if required)'
complete -c openclaw -n "__fish_seen_subcommand_from get" -l timeout -d 'Timeout in ms'
complete -c openclaw -n "__fish_seen_subcommand_from get" -l expect-final -d 'Wait for final response (agent)'
...
complete -c openclaw -n "__fish_seen_subcommand_from runs" -l run-id -d 'Filter by cron run id'
...
complete -c openclaw -n "__fish_seen_subcommand_from run" -l wait -d 'Wait for the queued run to finish'
complete -c openclaw -n "__fish_seen_subcommand_from run" -l wait-timeout -d 'Maximum time to wait for --wait'
complete -c openclaw -n "__fish_seen_subcommand_from run" -l poll-interval -d 'Polling interval for --wait'
...
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l tz -d 'Timezone for cron expressions (IANA; cron default: Gateway host local timezone)'
...
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l thread-id -d 'Telegram forum topic thread id'
...
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l failure-alert-include-skipped -d 'Count consecutive skipped runs toward alerts'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l failure-alert-exclude-skipped -d 'Alert only on execution errors'
...
complete -c openclaw -n "__fish_seen_subcommand_from proxy" -a "validate" -d 'Validate the operator-managed network proxy'
...
complete -c openclaw -n "__fish_seen_subcommand_from validate" -l json -d 'Print machine-readable JSON'
complete -c openclaw -n "__fish_seen_subcommand_from validate" -l proxy-url -d 'Proxy URL to validate instead of config/env'
complete -c openclaw -n "__fish_seen_subcommand_from validate" -l proxy-ca-file -d 'CA bundle file for verifying an HTTPS proxy endpoint'
complete -c openclaw -n "__fish_seen_subcommand_from validate" -l allowed-url -d 'Destination expected to succeed through the proxy'
complete -c openclaw -n "__fish_seen_subcommand_from validate" -l denied-url -d 'Destination expected to be blocked by the proxy'
complete -c openclaw -n "__fish_seen_subcommand_from validate" -l apns-reachable -d 'Also verify sandbox APNs HTTP/2 is reachable through the proxy'
complete -c openclaw -n "__fish_seen_subcommand_from validate" -l apns-authority -d 'APNs authority to probe with --apns-reachable'
complete -c openclaw -n "__fish_seen_subcommand_from validate" -l timeout-ms -d 'Per-request timeout in milliseconds'
...
complete -c openclaw -n "__fish_seen_subcommand_from hooks" -a "relay" -d 'Internal native harness hook relay'
...
complete -c openclaw -n "__fish_seen_subcommand_from relay" -l provider -d 'Native harness provider'
complete -c openclaw -n "__fish_seen_subcommand_from relay" -l relay-id -d 'Native hook relay id'
complete -c openclaw -n "__fish_seen_subcommand_from relay" -l event -d 'Native hook event'
complete -c openclaw -n "__fish_seen_subcommand_from relay" -l timeout -d 'Gateway timeout in ms'
...
complete -c openclaw -n "__fish_seen_subcommand_from plugins" -a "search" -d 'Search ClawHub plugin packages'
...
complete -c openclaw -n "__fish_seen_subcommand_from plugins" -a "install" -d 'Install a plugin or hook pack (path, archive, npm spec, git repo, clawhub:package, or marketplace entry)'
complete -c openclaw -n "__fish_seen_subcommand_from plugins" -a "update" -d 'Update installed plugins and tracked hook packs'
complete -c openclaw -n "__fish_seen_subcommand_from plugins" -a "registry" -d 'Inspect or rebuild the persisted plugin registry'
complete -c openclaw -n "__fish_seen_subcommand_from plugins" -a "doctor" -d 'Report plugin load issues'
complete -c openclaw -n "__fish_seen_subcommand_from plugins" -a "build" -d 'Generate simple tool plugin metadata'
complete -c openclaw -n "__fish_seen_subcommand_from plugins" -a "validate" -d 'Validate simple tool plugin metadata'
complete -c openclaw -n "__fish_seen_subcommand_from plugins" -a "init" -d 'Create a simple tool plugin project'
...
complete -c openclaw -n "__fish_seen_subcommand_from inspect" -l runtime -d 'Load plugin runtime for hooks/tools/diagnostics'
...
complete -c openclaw -n "__fish_seen_subcommand_from registry" -l json -d 'Print JSON'
complete -c openclaw -n "__fish_seen_subcommand_from registry" -l refresh -d 'Rebuild the persisted registry from current plugin manifests'
complete -c openclaw -n "__fish_seen_subcommand_from build" -l root -d 'Plugin package root'
complete -c openclaw -n "__fish_seen_subcommand_from build" -l entry -d 'Plugin entry module relative to --root'
complete -c openclaw -n "__fish_seen_subcommand_from build" -l check -d 'Fail if generated metadata is out of date'
complete -c openclaw -n "__fish_seen_subcommand_from validate" -l root -d 'Plugin package root'
complete -c openclaw -n "__fish_seen_subcommand_from validate" -l entry -d 'Plugin entry module relative to --root'
complete -c openclaw -n "__fish_seen_subcommand_from init" -l directory -d 'Output directory'
complete -c openclaw -n "__fish_seen_subcommand_from init" -l name -d 'Display name'
complete -c openclaw -n "__fish_seen_subcommand_from init" -l force -d 'Overwrite an existing output directory'
complete -c openclaw -n "__fish_seen_subcommand_from marketplace" -a "list" -d 'List plugins published by a marketplace source'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Print JSON'
complete -c openclaw -n "__fish_seen_subcommand_from channels" -a "list" -d 'List chat channels (configured by default; pass --all for installable catalog)'
...
complete -c openclaw -n "__fish_seen_subcommand_from list" -l all -d 'Include bundled and installable catalog channels'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from status" -l channel -d 'Only show one channel (all|telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch)'
complete -c openclaw -n "__fish_seen_subcommand_from status" -l probe -d 'Probe channel credentials'
complete -c openclaw -n "__fish_seen_subcommand_from status" -l timeout -d 'Timeout in ms'
complete -c openclaw -n "__fish_seen_subcommand_from status" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from capabilities" -l channel -d 'Channel (all|telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch)'
...
complete -c openclaw -n "__fish_seen_subcommand_from resolve" -l channel -d 'Channel (telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch)'
...
complete -c openclaw -n "__fish_seen_subcommand_from logs" -l channel -d 'Channel (all|telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch)'
...
complete -c openclaw -n "__fish_seen_subcommand_from add" -l token -d 'Channel token or credential payload'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l token-file -d 'Read channel token or credential payload from file'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l secret -d 'Channel shared secret'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l secret-file -d 'Read channel shared secret from file'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l bot-token -d 'Bot token'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l app-token -d 'App token'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l password -d 'Channel password or login secret'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l cli-path -d 'Channel CLI path'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l url -d 'Channel setup URL'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l base-url -d 'Channel base URL'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l http-url -d 'Channel HTTP service URL'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l auth-dir -d 'Channel auth directory override'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l use-env -d 'Use env-backed credentials when supported'
...
complete -c openclaw -n "__fish_seen_subcommand_from add" -l http-host -d 'Signal HTTP daemon host'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l http-port -d 'Signal HTTP daemon port'
complete -c openclaw -n "__fish_seen_subcommand_from remove" -l channel -d 'Channel (telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|line|zalo|clickclack|zalouser|synology-chat|tlon|qa-channel|qqbot|twitch)'
...
complete -c openclaw -n "__fish_seen_subcommand_from audit" -l deep -d 'Attempt live Gateway probes and plugin-owned collector checks'
...
complete -c openclaw -n "__fish_seen_subcommand_from skills" -a "check" -d 'Check which skills are ready, visible, or missing requirements'
complete -c openclaw -n "__fish_seen_subcommand_from skills" -l agent -d 'Target agent workspace (defaults to cwd-inferred, then default agent)'
complete -c openclaw -n "__fish_seen_subcommand_from search" -l limit -d 'Max results'
...
complete -c openclaw -n "__fish_seen_subcommand_from install" -l agent -d 'Target agent workspace (defaults to cwd-inferred, then default agent)'
complete -c openclaw -n "__fish_seen_subcommand_from update" -l all -d 'Update all tracked ClawHub skills'
complete -c openclaw -n "__fish_seen_subcommand_from update" -l agent -d 'Target agent workspace (defaults to cwd-inferred, then default agent)'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Output as JSON'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l eligible -d 'Show only eligible (ready to use) skills'
complete -c openclaw -n "__fish_seen_subcommand_from list" -s v -l verbose -d 'Show more details including missing requirements'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l agent -d 'Target agent workspace (defaults to cwd-inferred, then default agent)'
complete -c openclaw -n "__fish_seen_subcommand_from info" -l json -d 'Output as JSON'
complete -c openclaw -n "__fish_seen_subcommand_from info" -l agent -d 'Target agent workspace (defaults to cwd-inferred, then default agent)'
complete -c openclaw -n "__fish_seen_subcommand_from check" -l agent -d 'Target agent workspace (defaults to cwd-inferred, then default agent)'
complete -c openclaw -n "__fish_seen_subcommand_from check" -l json -d 'Output as JSON'
complete -c openclaw -n "__fish_seen_subcommand_from update" -a "finalize" -d 'Run OpenClaw update finalization after an external core runtime change'
...
complete -c openclaw -n "__fish_seen_subcommand_from update" -l timeout -d 'Timeout for each update step in seconds (default: 1800)'
complete -c openclaw -n "__fish_seen_subcommand_from update" -l yes -d 'Skip confirmation prompts (non-interactive)'
complete -c openclaw -n "__fish_seen_subcommand_from finalize" -l json -d 'Output result as JSON'
complete -c openclaw -n "__fish_seen_subcommand_from finalize" -l channel -d 'Persist update channel for finalization'
complete -c openclaw -n "__fish_seen_subcommand_from finalize" -l timeout -d 'Timeout for update finalization steps in seconds (default: 1800)'
complete -c openclaw -n "__fish_seen_subcommand_from finalize" -l yes -d 'Skip confirmation prompts (non-interactive)'
complete -c openclaw -n "__fish_seen_subcommand_from finalize" -l no-restart -d 'Accepted for update command parity; finalization never restarts'
complete -c openclaw -n "__fish_seen_subcommand_from wizard" -l timeout -d 'Timeout for each update step in seconds (default: 1800)'
complete -c openclaw -n "__fish_seen_subcommand_from status" -l json -d 'Output result as JSON'
